        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="LoginHedar">Login</h4>
                    <div class="col-sm-12 text-center" id="messagess" style="font-size: 2em">
                ...
                <div class="modal-body">
                    <!--==============================  Form   ====================================================-->
                    <form action="http://localhost/Automotive/registration_system/Login/validation_user.html" method="post" id="LoginForm" data-toggle="validator">
